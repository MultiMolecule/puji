...
本隐私声明适用于噗叽团队（也被称作噗叽）（以下简称“我们”），描述了当您使用我们的服务（“服务”）时，我们如何以及为何可能收集、存储、使用和/或共享（“处理”）您的信息。例如当您：

- 访问我们的网站 [puji.danling.org](https://puji.danling.org) 或任何链接到本隐私声明的我们的网站时
- 使用我们的飞书机器人 [噗叽](https://applink.feishu.cn/T8OCw3f32nM8) 时
...
如果您仍有任何问题或关注，请通过[chenzhiyuan@pjlab.org](mailto:chenzhiyuan@pjlab.org)与我们联系。
...
<!-- 关于我们如何使用此类技术以及您如何拒绝某些cookies的具体信息，请查看我们的Cookie声明：danling.org/about/cookie。 -->
